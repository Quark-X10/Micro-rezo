...
?>
<h3>La réparation que vous souhaitez modifier a été modifié il y a moins d'une minute, veuillez vérifier avant de continuer</h3>
<h5>C'est une réparation pour M ou Mme <?php echo $donnees_en_bdd['nom'] ?></h5>
<div class="reparation_bdd">
	<form method="post" action="../index.php">
		<fieldset>
			<legend>La réparation modifiée</legend>
			<p>
	...
	<form method="post" action="../controleur/modifier_reparation.php">
		<fieldset>
			...
			<p>
				...
				<input type="hidden" name="reparation_id" id="reparation_id" value="<?php echo $donnees['reparation_id']; ?>"/>
				<p class="description_panne">
					<label for="description_panne">Description<br />et panne : </label>
